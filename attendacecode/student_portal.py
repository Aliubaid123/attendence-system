def run_student_portal():
    ...
    students = [
        {
            "Batch": "2023", "Degree": "ICS", "RollNo": "ICS-101", "Name": "Ali Khan", "Username": "alikhan", "Password": "ali123",
            "FatherName": "Ahmed Khan", "Contact": "03001234567", "Address": "Lahore", "CNIC": "35201-1234567-1",
            "Email": "ali.khan@example.com"
        },
        {
            "Batch": "2023", "Degree": "FSC", "RollNo": "FSc-102", "Name": "Sara Ahmed", "Username": "sara", "Password": "sara456",
            "FatherName": "Imran Ahmed", "Contact": "03011234567", "Address": "Karachi", "CNIC": "42101-2345678-2",
            "Email": "sara.ahmed@example.com"
        },
        {
            "Batch": "2024", "Degree": "ICOM", "RollNo": "Icom-201", "Name": "Usman Malik", "Username": "usman", "Password": "usman789",
    ...
    def student_login():
        ...
        for student in students:
            if (student["Batch"] == batch and student["Degree"] == degree and
                student["RollNo"].upper() == roll_no and student["Username"] == username):
